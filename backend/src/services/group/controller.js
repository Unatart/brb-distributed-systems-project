            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        id = req.params.id;
                        if (!this.uuid_regex.test(id)) return [3 /*break*/, 2];
                        return [4 /*yield*/, this.db_manager.get(id)];
                    case 1:
                        result = _a.sent();
                        queue_1.queue.push({
                            user_id: req.query.user_id,
                            service_name: host_config_1.host.GROUP.name,
                            method: "GET",
        ...
        _this.set = function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 4, , 5]);
                        return [4 /*yield*/, helpers_1.getThroughMiddleware(req.body.user_id, host_config_1.host.USER.port + "/users", this.token)];
                    case 1:
                        user = _a.sent();
                        this.token = user.token;
                        if (!(user.exist === true)) return [3 /*break*/, 3];
                        return [4 /*yield*/, this.db_manager.set(req.body)];
                    case 2:
                        result = _a.sent();
                        queue_1.queue.push({
                            user_id: req.query.user_id,
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.db_manager.delete(req.params.id)];
                    case 1:
                        result = _a.sent();
                        queue_1.queue.push({
                            user_id: req.query.user_id,
